...
static irqreturn_t hall_interrupt(int irq, void *data)
{
	...
	int hall_gpio;
	pr_err("hall_interrupt begin begin begin begin *********.\n");
	...
	if (hall_gpio) {
	pr_err("hall_interrupt hall open 11111 .\n");
